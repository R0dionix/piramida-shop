...
const menuBody = document.querySelector('.header-mobile');
const links = Array.from(menuList.children);

if (menuBtn) {
  menuBtn.addEventListener("click", function (e) {
    document.body.classList.toggle('body-lock');
    menuBtn.classList.toggle('menu-btn--active');
    menuBody.classList.toggle('header-mobile--active');
  });
}
...
function closeOnClick() {
    ...
    menuBody.classList.remove('header-mobile--active');
}
"use strict"
...
// swiper slider
const Mainswiper = new Swiper('.promo-slider', {
  // Optional parameters
  loop: true,
  speed: 700,
  grabCursor: true,
...
// filter-btn
const filterBtn = document.querySelector('.catalog-btn');
const filterBody = document.querySelector('.catalog__sidebar');

if (filterBtn) {
  filterBtn.addEventListener("click", function (e) {
    filterBody.classList.toggle('catalog__sidebar--active');
  });
}

// product slider
const ProductThumbSwiper = new Swiper('.product-thumbnail', {
  spaceBetween: 15,
  navigation: {
    nextEl: '.swiper-button-next',
    prevEl: '.swiper-button-prev',
